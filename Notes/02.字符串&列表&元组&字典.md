...
print(str1.count('wor', start=0, end=len(str1))) # 返回'wor'在start和end之间在str1里面出现的次数
...
print(str1.rfind('wor', start=0,end=len(str1))) # rfind类似于find函数，不过是从右边开始查找.
print(str1.rindex('wor',start=0,end=len(str1))) # 类似于index，不过是从右边开始.
