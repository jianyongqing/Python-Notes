...
<br>2.语法简介优雅，容易阅读
<br>3.跨平台，可以运行Windows，Linux，macos
<br>4.易于学习的语言，吧编程语言当做解决问题的工具
<br>5.极为强大的标准库和第三方库，eg：电子邮件，图形界面
<br>6.Python既有动态脚本的特性，又有面向对象的特性

<br>运行效率较慢（编译型语言和解释型语言）运行效率和开发效率
